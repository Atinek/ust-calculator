...
class CalculatorControllerAdditionTest extends TestCase
{
    public function testV1Addition_WithoutAnyParameter_ValidationError()
    {
        $inputs = [];
        $expectedAnswer = [
            "error" => [
        ...
        $response = $this->post('/v1/add/', $inputs);
    ...
    public function testV1Addition_ifNum1IsMissing_ValidationError()
    {
        $num1 = 12;
        $num2 = null;
        $inputs = [
    ...
    public function testV1Addition_SumOfPositiveNumber_PostiveNumber()
    {
    ...
    public function testV1Addition_SumOfNegativeNumber_ValidationError()
    {
    ...
    public function testV1Addition_SumOfFloatingNumber_FloatingNumber()
    {
    ...
    public function testV1Addition_inputShouldBeNumbers()
    {
        $num1 = "one";
        $num2 = "two";
         $inputs = [
